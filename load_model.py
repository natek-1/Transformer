...
path = "best_model.pt"
src_tokenizer = get_or_build_tokenizer(config, None, config['lang_src'])
tgt_tokenizer = get_or_build_tokenizer(config, None, config['lang_tgt'])
